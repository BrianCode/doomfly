...
// Original 16 × 16 interface glyphs; integer geometry keeps the edges crisp.
const paths={
 ...
 ammo:'M3 1h2v2h1v10H2V3h1V1zm7 2h2v2h1v8H9V5h1V3zM1 14h6v2H1v-2zm7 0h6v2H8v-2z',
 ...
 download:'M6 0h4v7h3v2h-1v1h-1v1h-1v1H6v-1H5v-1H4V9H3V7h3V0zM1 12h2v2h10v-2h2v4H1v-4z',
...
export function PixelIcon({name,...props}:SVGProps<SVGSVGElement>&{name:PixelIconName}){return <svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor" shapeRendering="crispEdges" aria-hidden="true" focusable="false" {...props}><path fillRule="evenodd" d={paths[name]}/></svg>}
